...
### To fix codecs error:
```bash
sudo dnf -y swap ffmpeg-free ffmpeg --allowerasing && dnf install -y gstreamer gstreamer-plugins-base gstreamer-plugins-good gstreamer-plugins-bad gstreamer-plugins-ugly gstreamer-libav gstreamer1-plugins-bad-freeworld gstreamer1-plugins-ugly-freeworld
```
